...
urlpatterns = patterns('',
        ...
        url(r'^api/(?P<name>[a-zA-Z0-9]{4,20})/trainbymonth/$', CustomerTrainByMonth.as_view()),
        url(r'^api/(?P<name>[a-zA-Z0-9]{4,20})/coachtrain/$', CoachTrainList.as_view()),
...
#        url(r'^api/(?P<name>[a-zA-Z0-9]{4,20})/scheduletask/$', ScheduleTask.as_view()),
        ...
        url(r'^api/(?P<name>[a-zA-Z0-9]{4,20})/customerswithmonthtraintimes/$', CustomerWithMonthTrainTimesList.as_view()),
        ...
        url(r'^api/(?P<name>[a-zA-Z0-9]{4,20})/g/(?P<gymid>[0-9]+)/balance/$', BalanceItemPatch.as_view()),
