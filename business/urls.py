...
urlpatterns = patterns('',
		...
		url(r'^api/refund/(?P<pk>[0-9]{0,8})/$', RefundItem.as_view()),
		url(r'^api/invoice/(?P<pk>[0-9]{0,8})/$', InvoiceItemView.as_view()),
		...
		url(r'^api/g/(?P<pk>[0-9]+)/chart/$', GymChart.as_view()),
		url(r'^api/g/(?P<pk>[0-9]+)/liveness/(?P<year>[0-9]{4})/(?P<month>[0-9]{1,2})/$', GymCustomerLiveness.as_view()),
		url(r'^api/g/(?P<pk>[0-9]+)/billboard/(?P<year>[0-9]{4})/(?P<month>[0-9]{1,2})/$',GymCustomerMonthBillboard.as_view()),
		...
		url(r'^api/g/(?P<pk>[0-9]+)/refund/$', RefundList.as_view()),
		url(r'^api/g/(?P<pk>[0-9]+)/invoice/$', GymInvoiceList.as_view()),
		url(r'^api/g/(?P<pk>[0-9]+)/reimbursement/$', GymReimbursementList.as_view()),
		...
		url(r'^api/s/(?P<course>[0-9]+)/review/patch/$',CourseReviewItemPatch.as_view()),
		url(r'^api/(?P<name>[a-zA-Z0-9]{4,64})/review/$', CustomerCourseReviewList.as_view()),
		url(r'^api/(?P<name>[a-zA-Z0-9]{4,64})/review/(?P<year>[0-9]{4})/(?P<month>[0-9]{1,2})/$', CustomerCourseReviewListByMonth.as_view()),
		...
		url(r'^api/(?P<pk>[a-zA-Z0-9]{4,64})/traintimeline/(?P<year>[0-9]{4})/(?P<month>[0-9]{1,2})/$',CustomerTrainTimeline.as_view()),
		url(r'^api/(?P<pk>[a-zA-Z0-9]{4,64})/tips/$',CustomerTipsView.as_view()),
                url(r'^api/(?P<name>[a-zA-Z0-9]{4,64})/ranking/$', TrainTimesRanking.as_view()),
		...
		#body eval
                ...
                url(r'^api/(?P<customer>[a-zA-Z0-9]{4,20})/bonus/$', CustomerBonusView.as_view()),
                ...
                url(r'^api/(?P<name>[a-zA-Z0-9]{4,20})/coaches/$', CurrentCoaches.as_view()),
