...
class OrderItemById(generics.RetrieveUpdateDestroyAPIView):
	...
	def update(self, request, *args, **kwargs):
		...
		if "amount" in request.data:
			...
			order.product.save()
		if "coursecount" in request.data:
			order.product.amount = request.data["coursecount"]
			order.product.save()
		'''
...
class ManualOrder(APIView):
	...
	def post(self,request,name):
		...
		if "product_duration_type" in request.data:
			order.product_duration_type = request.data["product_duration_type"]
			order.save()
