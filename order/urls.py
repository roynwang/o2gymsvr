...
urlpatterns = patterns('',
		...
		url(r'^api/(?P<name>[a-zA-Z0-9]{4,64})/o/charge/$',ChargeScheduleList.as_view()),
		...
		url(r'^api/g/(?P<pk>[0-9]+)/(?P<name>[a-zA-Z0-9]{4,64})/chargemonth/$',ChargeMonth.as_view()),
		...
		url(r'^api/g/(?P<gymid>[0-9]+)/expired/$',GymOrderExpired.as_view()),
		url(r'^api/g/(?P<gymid>[0-9]+)/chart/$',GymChart.as_view()),
		url(r'^api/g/(?P<gymid>[0-9]+)/schedulechart/$',GymScheduleChart.as_view()),
